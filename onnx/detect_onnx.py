...
class heatmap_onnx():
    def __init__(self, onnx_path, classes_list):
        ...
        # self.ort_session.set_providers(['CPUExecutionProvider'])  # 使用cpu
    ...
    def detect(self, images):
        ...
        for i, image in enumerate(images):
            scale_min = min(self.new_shape[2] / image.shape[0], self.new_shape[3] / image.shape[1])
...
if __name__ == '__main__':
    classes_list = [str(i) for i in range(6)]  # 6个关键点
    onnx_path = r"./u2net_p_196_epoch.onnx"
